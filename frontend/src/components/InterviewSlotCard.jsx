...
const InterviewSlotCard = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 grid gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 ">
      {slots.map((slot) => (
        <div
          key={slot._id}
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-richblack-800 p-6 rounded-lg w-96 space-y-2 relative border-2 ">
            ...
            <div className="flex justify-end space-x-4">
              <button
                className="w-full px-6 py-3 mt-6 text-base font-bold rounded-lg shadow-md transition-all duration-300 bg-yellow-25 text-richblack-900 hover:scale-105"
